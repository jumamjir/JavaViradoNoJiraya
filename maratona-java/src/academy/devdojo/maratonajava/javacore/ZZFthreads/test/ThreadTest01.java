...
// Daemon x User
// Daemon: é uma thread que executa em background, ela não impede o encerramento do programa
// User: é uma thread que executa em foreground, ela impede o encerramento do programa
